...
public class Solution {
    ...
    /*т.к. модификатор иннер класса private, то чтобы вызвать метод getDescription из
     другого внешнего класса, нужно обернуть его вызов в какой-то public метод*/
    ...
    public static void main(String[] args) {
        ...
        //внутри класса Solution (а сейчас мы внутри) к методу
        // getDescription можно обращаться обоими способами
