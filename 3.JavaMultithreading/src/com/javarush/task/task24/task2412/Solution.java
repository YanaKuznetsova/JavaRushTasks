...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int compareNames = ((String) stock1.get("name")).
                        compareTo((String) stock2.get("name"));
                if (compareNames != 0){
                    return compareNames;
                } else {
                    int compareDates = ((Date) stock1.get("date")).
                            compareTo((Date) stock2.get("date"));
                    if (compareDates != 0) {
                        return compareDates;
                    } else {
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 120.64, 123.43));
