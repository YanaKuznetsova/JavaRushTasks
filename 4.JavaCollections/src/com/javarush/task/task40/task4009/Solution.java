...
public class Solution {
    ...
    public static String weekDayOfBirthday(String birthday, String year) {
        LocalDate localDate = LocalDate.parse(birthday, DateTimeFormatter.ofPattern("d.M.yyyy"));
        localDate = localDate.with(Year.parse(year));
        return localDate.getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.ITALIAN).toLowerCase();
    }
